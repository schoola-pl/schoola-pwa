...
const AppointmentIcon: React.FC<Props> = ({ isActive }) => {
  return (
    <svg fill={isActive ? '#FFFFFF' : '#72db88'} xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
      <path
